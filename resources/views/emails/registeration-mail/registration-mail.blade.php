{{-- <x-mail::message>
    ...
    <a target="_blank" href="{{ config('app.frontend_url') }}/resetPassword?token={{ $token }}"
        style="background-color:#ffc952;border-radius:4px;color:#222222;display:inline-block;font-size:13px;font-weight:600;line-height:44px;text-align:center;text-decoration:none;text-transform: uppercase; padding: 0 30px">
        ...
        <tbody>
            ...
            <tr>
                <td style="padding: 0 30px 20px; color: #dae2f1">
                    ...
                    <p style="margin-bottom: 10px;">Welcome to kstore! <br> Congragulation!!!!! you're now part of the kstore
                        family!!!
                    </p>
