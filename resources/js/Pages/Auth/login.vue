            ...
            <GuestLayout>
                <div class="mx-auto" v-if="formStep == 1">
                    ...
                    >
                        ...
                        <p
                            class="text-[1.25rem] leading-normal text-[#000000] text-center"
                        >
                            Welcome to Kstore
                        </p>
                ...
                <div class="mx-auto" v-if="formStep == 2">
                    ...
                    >
                        <img :src="image_1" class="w-14 h-14" alt="" />
                        <p
                            class="text-[1.25rem] leading-normal text-[#000000] font-bold text-center"
                        >
                            Create your account
                        </p>
                        ...
                        >
                            ...
                            <div>
                                To keep you account safe, we need a strong
                                password
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="flex items-center justify-between text-center bg-gray-400"
                    >
                ...
                <div class="mx-auto" v-if="formStep == 3">
                    ...
                    <div class="mt-[16px]">
                        ...
                        >
                        <div
                            class="relative z-0 w-full group mt-4 flex justify-between"
                        >
                    ...
                    <div class="mt-[1rem]">
                        <Button btn="jumia-color" @click="next3">
                            continue
                        </Button>
                    </div>
                </div>
                ...
                <div class="mx-auto" v-if="formStep == 4">
                    ...
                    <div class="mt-[1rem]">
                        <Button btn="jumia-color" @click="submit">
                            continue
                        </Button>
                    </div>
                </div>
